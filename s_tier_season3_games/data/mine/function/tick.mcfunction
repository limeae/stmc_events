...
execute if score mine.handler mine.stage.creaking matches 0 if score mine.handler mine.stage.hoglin matches 0 if score mine.handler mine.stage.warden matches 0 if score mine.handler mine.stage.lobby matches 1 in mine:lobby run mine:load
