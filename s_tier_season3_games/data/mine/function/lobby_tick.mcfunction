...
execute if score mine.handler mine.timer.summon matches 0 as @e[type=skeleton] run scoreboard players add mine.handler mine.timer.summon 80
execute if score mine.handler mine.timer.summon matches 0 as @e[type=stray] run scoreboard players add mine.handler mine.timer.summon 80
execute if score mine.handler mine.timer.summon matches 0 as @e[type=zombie] run scoreboard players add mine.handler mine.timer.summon 80
execute if score mine.handler mine.timer.summon matches 0 as @e[type=drowned] run scoreboard players add mine.handler mine.timer.summon 80
...
scoreboard players add mine.handler mine.timer.lobby 1
