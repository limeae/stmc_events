...
execute if score mine.handler mine.timer matches 600 as @a[gamemode=adventure] at @s rotated as @s rotated ~ 0 positioned ^10 ^ ^10 run function mine:mobs/game/hoglin/hoglin
