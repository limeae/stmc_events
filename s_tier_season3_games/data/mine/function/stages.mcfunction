...
execute if score mine.handler mine.stage.creaking matches 1 if score mine.handler mine.stage.lobby matches 1 in mine:creaking run function mine:start
...
execute if score mine.handler mine.stage.hoglin matches 1 if score mine.handler mine.stage.lobby matches 1 in mine:hoglin run function mine:start
...
execute if score mine.handler mine.stage.warden matches 1 if score mine.handler mine.stage.lobby matches 1 in mine:warden run function mine:start

execute if score mine.handler mine.stage.creaking matches 1 in mine:creaking run function mine:creaking_tick
execute if score mine.handler mine.stage.creaking matches 1 in mine:creaking run function mine:tick

execute if score mine.handler mine.stage.hoglin matches 1 in mine:hoglin run function mine:hoglin_tick
execute if score mine.handler mine.stage.hoglin matches 1 in mine:hoglin run function mine:tick

execute if score mine.handler mine.stage.warden matches 1 in mine:warden run function mine:warden_tick
execute if score mine.handler mine.stage.warden matches 1 in mine:warden run function mine:tick

execute if score mine.handler mine.stage.lobby matches 1 in mine:lobby run function mine:lobby_tick
execute if score mine.handler mine.stage.lobby matches 1 in mine:lobby run function mine:tick
